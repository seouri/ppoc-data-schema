...
def ages(ctx: Context) -> list[Finding]:
    ...
    f.blocks = [
        ...
        Para("**Why the line is at {split:.0f} years.** The cutoff comes from "
             ...
             "and two analyses in this report already restrict themselves to age 2 "
             "or later for the same reason — the repeat-height intervals of 4.5 "
             "and the growth profile of 4.9. "
