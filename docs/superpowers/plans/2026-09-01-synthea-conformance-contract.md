...
- [ ] **Step 3: Implement the minimal fail-closed contract.**
...
- [ ] **Step 2: Run documentation/boundary tests to verify the red state.**
...
- [ ] **Step 3: Add the guide and cross-document links.**
...
- [ ] **Step 4: Run docs/boundary tests, lint, and commit.**
...
- [ ] Every public field, fixed value, parser rejection, serialization rule, boundary, and deferred item in the spec maps to Task 1 tests/implementation or Task 2 docs/static tests.
- [ ] No plan step uses placeholder wording or an unspecified validation instruction.
- [ ] The method names, field names, fixed strings, and test-only semantics are consistent across the spec, implementation task, documentation task, and verification task.
- [ ] The plan never authorizes Synthea execution, source checkout access, network downloads, patient data, or release promotion.
