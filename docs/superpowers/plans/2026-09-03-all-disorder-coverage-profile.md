...
- `AgeRegimeConfig.puberty_sampling_max_age_days` is optional and defaults to the existing `puberty_max_age_days`; the all-disorder config uses sampling max `5114` with validation max `5834` so constitutional-delay adjustments remain valid without changing legacy replay behavior.
...
- [x] **Step 1: Write failing model and dispatch tests.**
...
- [x] **Step 3: Implement the immutable adapter and bundle seam.**
...
- [x] **Step 2: Run the eligibility tests to verify they fail.**
...
- [x] **Step 3: Implement conditional filtering without changing existing draws.**
...
- [x] **Step 5: Commit conditional selection.**
...
- [x] **Step 1: Write failing runtime/CLI tests.**
...
- [x] **Step 4: Run focused runtime/CLI tests and static checks.**
...
- [x] **Step 5: Commit the runtime route.**
...
- [x] **Step 3: Update the guide and companion roadmap references.**
...
- [x] **Step 4: Run docs tests and checks.**
...
- [x] **Step 1: Record the ledger and task reviews.**
...
- [x] **Step 3: Obtain the broad review.**
