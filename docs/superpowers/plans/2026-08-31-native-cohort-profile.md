...
- [ ] **Step 2: Run model tests to verify the API is absent/incomplete**
...
- [ ] **Step 3: Implement immutable validation models**
...
- [ ] **Step 1: Write failing profile extraction tests**
...
- [ ] **Step 3: Implement strict artifact-to-profile conversion**
...
- [ ] **Step 4: Run profile tests, lint, and commit**
...
- [ ] **Step 2: Run generation tests to verify the orchestration is absent**
...
- [ ] **Step 3: Implement deterministic demographic and module sampling**
...
- [ ] **Step 4: Run generation tests, lint, and commit**
...
- [ ] **Step 1: Write failing resource-integration tests**
...
- [ ] **Step 2: Run resource tests to verify the bridge is incomplete**
...
- [ ] **Step 3: Implement optional descriptor projection and aggregate result**
...
- [ ] **Step 2: Run documentation/boundary tests to verify the section is absent**
...
- [ ] **Step 3: Update documentation and boundary scan**
...
- [ ] **Step 4: Run task checks and commit**
...
- [ ] **Step 1: Create the plan-owned SDD ledger and dispatch fresh task reviewers**
...
- [ ] **Step 2: Run the broad whole-branch review**
