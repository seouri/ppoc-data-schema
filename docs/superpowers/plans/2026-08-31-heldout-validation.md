...
> Reconciliation note: Tasks 1–4 were already implemented in the held-out commits preceding this handoff. The whole-slice review found three staging-boundary gaps; a fresh implementer fixed them in `5043f8a` and the scoped re-review passed. Evidence is recorded in `.superpowers/sdd/2026-08-31-heldout-validation/`.
...
- [x] Step 1: Write failing partition-label and staging tests
...
- [x] Step 2: Run focused tests to verify the new APIs fail
...
- [x] Step 3: Refactor target SQL to use a validated parameter
...
- [x] Step 4: Factor exact-schema staging and implement synthetic staging
...
- [x] Step 5: Run target/staging tests, lint, and commit
...
- [x] Step 1: Write failing model/policy/comparison tests
...
- [x] Step 2: Run policy/comparison tests to verify they fail
...
- [x] Step 3: Implement strict policy parsing and immutable models
...
- [x] Step 4: Implement fixed target matching, tolerance, and report serialization
...
- [x] Step 1: Write failing integration/CLI/lifecycle tests
...
- [x] Step 3: Implement explicit configuration and compatibility gates
...
- [x] Step 4: Implement transactional report output and CLI exit semantics
...
- [x] Step 5: Run integration/CLI tests, lint, and commit
...
- [x] Step 3: Update documentation and add boundary guard
...
- [x] Step 2: Dispatch the broad whole-branch review
...
- [x] Step 3: Finish, merge, push, and verify remote parity
