...
- [x] **Step 3: Implement strict frozen models**
...
- [x] **Step 1: Write failing metric tests and typed fictional fixtures**
...
- [x] **Step 3: Implement private metric extraction and public evaluation**
...
- [x] **Step 4: Run metrics, lint, and commit**
...
- [x] **Step 1: Write failing subgroup/status tests**
...
- [x] **Step 2: Run subgroup tests to verify they fail**
...
- [x] **Step 3: Implement fixed subgroup cells and report invariants**
...
- [x] **Step 4: Run subgroup tests, all task tests, lint, and commit**
...
- [x] **Step 2: Run boundary/docs tests to verify they fail**
...
- [x] **Step 3: Implement the AST guards and guide/README section**
...
- [x] **Step 4: Run focused suite, Ruff, schema, and commit**
...
- [x] **Step 1: Run fresh scoped reviews after each implementation task**
...
- [x] **Step 2: Run one broad review across the complete slice**
...
- [x] **Step 3: Verify and update plan metadata**
