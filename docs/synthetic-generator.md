...
result = AgeRegimeDisorderKernel(
    AgeRegimeTrajectoryKernel(reference), FamilialShortStatureModule()
).generate(
    PatientState("synthetic-disorder", "F", "F"),
    (0, 730, 761, 3_287, 4_500, 7_305),
