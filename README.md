...
This evaluator boundary neither creates augmented resources nor enables package or file export. It is not prevalence, privacy/non-matchability, or Synthea evidence. Augmented resources, exact-schema package export, manifests, prevalence and demographic calibration, held-out validation, privacy evaluation, and Synthea conformance remain separate deferred gates. See [the observed-resource section](docs/synthetic-generator.md#evaluator-only-observed-resource-bundles) for an in-memory example and detailed limits.
